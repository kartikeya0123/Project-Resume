# Vibe Coding Workshop Repository

## 🚀 Quick Start Guide

### Step 0 — Read the FAQ.md
...
```
Open a Pull Request against main on the upstream repo. Use the PR template — fill every section.
...
## 🎯 Getting Started
1. Choose your city (pune, hyderabad, kolkata, ahmedabad)
2. Start with UC-0A (Complaint Classifier)
3. Follow the README in each UC folder
4. Commit after each UC with proper message format
5. Submit PR when all 4 UCs are complete
